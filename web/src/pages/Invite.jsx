  ...
  const fetchLinks = async () => {
    try {
      ...
      if (isStaff) {
        ...
        setInvitesLeft(50 - sortedLinks.length);
      }
            ...
            <div className="remaining-invites">
              ...
              <div className="count-box">
                <span className="count-number">
                  {invitesLeft === Infinity ? "무한" : invitesLeft}
                </span>
          ...
          <div className="modal-overlay">
            <div className="del-modal-content">
              ...
              <div className="invite-modal-buttons">
                <button
                  className="invite-modal-button invite-cancel-button"
                  onClick={closeRevokeModal}
                >
                  취소
                </button>
                <button
                  className="invite-modal-button invite-confirm-button"
