...
function Certify() {
    ...
    const checkIsKaistEmail = () => {
        return email.endsWith("@kaist.ac.kr") || email.endsWith("@alumni.kaist.ac.kr");
    };
        ...
        <div className="certify">
            ...
            <div className="certify-email">
                <input
                    ...
                    value={email}
                    disabled={isVerified || codeSent} // 이메일 인증 성공 시 필드를 비활성화
                />
                {!codeSent && <button
                    type="button"
                    className="certify-emailBtn"
                    disabled={!emailBtnActive || isVerified || isLoading} // 이메일 인증 성공 시 버튼 비활성화
