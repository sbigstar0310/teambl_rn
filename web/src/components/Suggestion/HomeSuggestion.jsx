...
const HomeSuggestion = () => {
    ...
    if (maxLength > 0 || secondDegreeNum > 0) {
        return (
            <div className="home-suggestion-container">
                <div className="home-suggestion-title-container">
                    <span className="home-suggestion-title">
                        {"이번주 새로운 회원 소식"}
                    </span>
                    <button
                ...
                <div className="home-suggestion-sub-title">
                    {"나와 통하는 새로운 회원들을 만나보세요!"}
                </div>
