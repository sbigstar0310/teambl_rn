...
const ProjectViewProfileAndMenu = ({ isLoading, isRelationLoading, isOwner, data, projectId, updateList, ownerId, relationshipDegree }) => {
    ...
    const deleteProject = async () => {
        ...
        try {
            ...
            toastText("게시물이 삭제되었습니다.");
            await updateList();
        } catch (e) {
            console.log(e);
            toastText("게시물 삭제에 실패했습니다.");
        } finally {
    ...
    useEffect(() => {
        if ((!isImageLoaded) && data?.user?.profile?.image) {
