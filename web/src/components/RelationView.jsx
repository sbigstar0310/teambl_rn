 ...
 * @param {Array} relationIdList
 * @param {Number} chon 출발점과 도착점 사이의 촌수
 * @param {Boolean} isLoading 로딩 표시 여부
*/
function RelationView({ fromName, fromId, toName, relationList, relationIdList, chon, isLoading }) {
    ...
    return (
        <div className='relation-view-main-container'>
            ...
            <div className='relation-view-content-area with-top-margin-8'>
                <div className='relation-view-name-container from-flex-end'>
                    <span 
                        className='relation-view-name'
                        onClick={() => {navigate(`/profile/${fromId}`);}}
                    >
                        {fromName}
                    </span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="10" viewBox="0 0 158 2" fill="none" className='with-left-margin-12'>
                            ...
                            if (chon === 2) {
                                return (
                                    <div
                                        ...
                                        onClick={() => {navigate(`/profile/${relationIdList[index]}`);}}
                                    >
                                        {relation}
                                    </div>
                                );
                                ...
                                return (
                                    ...
                                    >
                                        <span
                                            onClick={() => {navigate(`/profile/${relationIdList[index][0]}`);}}
                                        >
                                            {relation[0]}
                                        </span>
                                        <svg
                                        ...
                                        <span
                                            onClick={() => {navigate(`/profile/${relationIdList[index][1]}`);}}
                                        >
                                            {relation[1]}
                                        </span>
                                    </div>
