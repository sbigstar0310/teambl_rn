...
const Reactions = ({ participants = [], likes, commentsLength, onCommentsClick, likesClick, liked }) => {
        ...
        <div className="project-reactions-section">
            <div className="project-participants-container">
                ...
                {displayedParticipants.map((participant, index) => (
                    <img
                        key={index}
                        src={participantImages[participant.id] ? participantImages[participant.id] : defaultProfileImage}
