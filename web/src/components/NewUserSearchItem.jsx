...
import NewUserIcon from "../assets/NewSearch/newuserIcon.svg";
import "../styles/NewSearch.css";

// 포함되어야 하는 정보
// 프로필 이미지, 이름, 촌수, 입학년도, 학교, 전공, 키워드들

const NewUserSearchItem = ({ isNew, user, onAddRelationShip, styleOv }) => {
  ...
  return (
    <div>
      <div
        className="newSearch-team-member"
      ...
      >
        ...
        <div className="newSearch-member-info">
          <div className="newSearch-member-name-relation">
            <div>
            ...
            {isNew && 
            <img 
              className="newSearch-member-new-user"
              src={NewUserIcon}
            />}
          </div>
