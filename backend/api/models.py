...
class MajorChoices(models.TextChoices):
    ...
    화학과 = "화학과", "화학과"
    #  석사, 박사
    나노과학기술대학원 = "나노과학기술대학원", "나노과학기술대학원"
    양자대학원 = "양자대학원", "양자대학원"
    #  학사
    생명과학과 = "생명과학과", "생명과학과"
    뇌인지과학과 = "뇌인지과학과", "뇌인지과학과"
    #  석사, 박사
    의과학대학원 = "의과학대학원", "의과학대학원"
    공학생물학대학원 = "공학생물학대학원", "공학생물학대학원"
    줄기세포및재생생물학대학원 = (
        "줄기세포및재생생물학대학원",
        "줄기세포및재생생물학대학원",
    )
    #  학사
    기계공학과 = "기계공학과", "기계공학과"
    항공우주공학과 = "항공우주공학과", "항공우주공학과"
    전기및전자공학부 = "전기및전자공학부", "전기및전자공학부"
    전산학부 = "전산학부", "전산학부"
    건설및환경공학과 = "건설및환경공학과", "건설및환경공학과"
    바이오및뇌공학과 = "바이오및뇌공학과", "바이오및뇌공학과"
    산업디자인학과 = "산업디자인학과", "산업디자인학과"
    산업시스템공학과 = "산업시스템공학과", "산업시스템공학과"
    생명화학공학과 = "생명화학공학과", "생명화학공학과"
    신소재공학과 = "신소재공학과", "신소재공학과"
    원자력및양자공학과 = "원자력및양자공학과", "원자력및양자공학과"
    반도체시스템공학과 = "반도체시스템공학과", "반도체시스템공학과"
    #  석사, 박사
    조천식모빌리티대학원 = "조천식모빌리티대학원", "조천식모빌리티대학원"
    김재철AI대학원 = "김재철AI대학원", "김재철AI대학원"
    녹색성장지속가능대학원 = "녹색성장지속가능대학원", "녹색성장지속가능대학원"
    반도체공학대학원 = "반도체공학대학원", "반도체공학대학원"
    인공지능반도체대학원 = "인공지능반도체대학원", "인공지능반도체대학원"
    메타버스대학원 = "메타버스대학원", "메타버스대학원"
    시스템아키텍트대학원 = "시스템아키텍트대학원", "시스템아키텍트대학원"
    #  학사
    디지털인문사회과학부 = "디지털인문사회과학부", "디지털인문사회과학부"
    #  석사, 박사
    문화기술대학원 = "문화기술대학원", "문화기술대학원"
    문술미래전략대학원 = "문술미래전략대학원", "문술미래전략대학원"
    과학기술정책대학원 = "과학기술정책대학원", "과학기술정책대학원"
    #  학사
    경영공학부 = "경영공학부", "경영공학부"
    기술경영학부 = "기술경영학부", "기술경영학부"
    #  석사, 박사
    KAIST경영전문대학원 = "KAIST경영전문대학원", "KAIST경영전문대학원"
    금융전문대학원 = "금융전문대학원", "금융전문대학원"
    경영자과정 = "경영자과정", "경영자과정"
    기술경영전문대학원 = "기술경영전문대학원", "기술경영전문대학원"
    글로벌디지털혁신대학원 = "글로벌디지털혁신대학원", "글로벌디지털혁신대학원"
    바이오혁신경영전문대학원 = "바이오혁신경영전문대학원", "바이오혁신경영전문대학원"
    #  학사
    융합인재학부 = "융합인재학부", "융합인재학부"
    #  석사, 박사
    안보과학기술대학원 = "안보과학기술대학원", "안보과학기술대학원"
    사이버안보기술대학원 = "사이버안보기술대학원", "사이버안보기술대학원"
    #  학사
    새내기과정학부 = "새내기과정학부", "새내기과정학부"
...
class Profile(models.Model):
    ...
    def update_profile_one_degree_count(self):
        """프로필 수정 시 일촌 수 같이 업데이트"""
        self.one_degree_count = Friend.objects.filter(
            Q(from_user_id=self.pk) | Q(to_user_id=self.pk), status="accepted"
        ).count()
        self.save()
