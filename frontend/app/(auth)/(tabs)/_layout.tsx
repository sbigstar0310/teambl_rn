          ...
          return {
            ...
            tabBarIcon: ({ focused }) => {
              const isMyProfileActive =
                ...
                (focusedRouteName === "myprofile" || focusedRouteName === "myprofile-edit");
              ...
              switch (route.name) {
                ...
                case "myprofile":
                  return (
                    <View
                      style={{
                        borderColor: isMyProfileActive ? "#2546F3" : "#595959",
                        borderWidth: 1,
                        borderRadius: 50,
                      }}
                    >
            ...
            tabBarLabel: ({ focused }) => {
              ...
              const isActive = focused || isMyProfileActive;

              return (
                <Text
                  style={{
                    color: isActive ? "#2546F3" : "#595959",
                    fontSize: 10,
                  }}
                >
                  {route.name === "home" && "홈"}
